	...
	<div class="container">
		...
		<div class="paymentCont col-sm-8">
			...
			<!--<form action="{{url('/order-place')}}" method="post">
					...
					<div class="paymentWrap">
						<div class="btn-group paymentBtnGroup btn-group-justified" data-toggle="buttons">
				            ...
				            <label class="btn paymentMethod">
				                ...
				                <input type="radio" name="payment_gateway" value="nogod"> 
				            </label>
				...
				<form action="{{url('/order-place')}}" method="post">
				   {{csrf_field()}}	
				   <input type="radio" name="payment_method" value="Handcash"> Handcash
				   <input type="radio" name="payment_method" value="Bkash"> Bkash
				   <input type="radio" name="payment_method" value="Nogod"> Nogod<br>
