			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-catagory')}}"><i class="icon-envelope"></i><span class="hidden-tablet">All catagory</span></a></li>
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{URL::to('/add-products')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add product</span></a></li>
								<li><a class="submenu" href="{{URL::to('/all-products')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All product</span></a></li>
								<
							</ul>	
						</li>
						<li>
						...
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet"> Dalevary man</span></a></li>
