				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{URL::to('/')}}"><img src="{{asset('asset/images/home/logo.png')}}" alt="" /></a>
						</div>
							...
							<ul class="nav navbar-nav">
								...
								<?php if($customer_id!=NULL && $shiping_id==NULL) {?>
								    ...
								    <li><a href="{{URL::to('/login-check')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								     ...
								     <li><a href="{{URL::to('/save-cart')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>

							<?php if($customer_id!=NULL) {?>
							<li><a href="{{URL::to('/customer-logout')}}"><i class="fa fa-user"></i>Logout</li>
							<?php } else{?>
							<li><a href="{{URL::to('/login-check')}}"><i class="fa fa-user"></i>Login</li>
							<?php }?>
							</ul>
						</div>
					</div>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
								        ...
								        <?php }?>
										<li><a href="{{URL::to('/save-cart')}}">Cart</a></li> 
                                    </ul>
                                </li> 
					...
					<div class="col-sm-3">
						...
						<form action="{{url('/search-product')}}" method="post">
						  {{csrf_field()}}
							...
							<button type="submit" style="border:0px; height:33px; margin-Left:-3px; background-color:#FFA500;">Go</button>
						</form>
						</div>
					</div>
				</div>
					...
					<div class="left-sidebar">
						...
						foreach($all_published_catagory as $vcatagory){
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{URL::to('/product_by_catagory/'.$vcatagory->catagory_id)}}">{{$vcatagory->catagory_name}}</a></h4>
								</div>
							</div>
						<?php	}?>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								...
								<li><a href="{{URL::to('/product_by_manufacture/'.$vmanufacture->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$vmanufacture->manufacture_name}}</a></li>
		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-7">
							...
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('asset/images/home/iframe1.png')}}" alt="" />
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('asset/images/home/iframe2.png')}}" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('asset/images/home/iframe3.png')}}" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('asset/images/home/iframe4.png')}}" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
					...
					<div class="col-sm-3">
						<div class="address">
							<img src="{{asset('asset/images/home/map.png')}}" alt="" />
